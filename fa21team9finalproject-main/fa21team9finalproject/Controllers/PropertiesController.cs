...
namespace fa21team9finalproject.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            foreach (Reservation reservation in reservations)
            {
                ...
                else if (reservation.Status == rStatus.Active && reservation.CheckInDate > DateTime.Now)
                {
                    ...
                    String ConfirmationNum = "Your confirmation number was: " + reservation.Order.OrderNumber.ToString();
                    Utilities.EmailMessaging.SendEmail(reservation.Order.User.Email, emailSubject, emailBod + ConfirmationNum);
                }
        ...
        public ActionResult AdminReportSearch(int SelectedCategory, PropertySearchViewModel psvm)
        {
            ...
            {
                TotalCommission += 0.10m * (reservation.ReservationTotal - reservation.CleaningFee);
            }
