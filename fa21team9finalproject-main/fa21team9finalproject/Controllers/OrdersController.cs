...
namespace fa21team9finalproject.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create(Int32? oid)
        {
            ...
            String ConfirmationNum = "Your confirmation number was: " + order.OrderNumber.ToString();
            Utilities.EmailMessaging.SendEmail(order.User.Email, emailSubject, emailBod + ConfirmationNum);
