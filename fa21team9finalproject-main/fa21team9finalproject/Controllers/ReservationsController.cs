                ...
                if (rmm.IdsToCancel != null)
                {
                    ...
                    foreach (Int32 reservationId in rmm.IdsToCancel)
                    {
                        ...
                        try
                        {
                            ...
                            String emailBod = "Your reservation has been cancelled. If you did not make this action, the host did. Please contact the host with any questions or concerns." + ConfirmationNum;
